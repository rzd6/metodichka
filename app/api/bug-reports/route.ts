...
export async function POST(req: NextRequest) {
  try {
    ...
    const { sender_nickname, sender_role, sender_position, from_section, message } = body
    ...
    const result = await db.query(
      `INSERT INTO bug_reports (sender_nickname, sender_role, sender_position, from_section, message)
       VALUES ($1, $2, $3, $4, $5)
       RETURNING *`,
      [sender_nickname, sender_role, sender_position, from_section, message]
    )
