    ...
    <>
      <div className="flex flex-col items-end gap-0.5">
        ...
        <span
          ...
          style={{ color: tieColor, opacity: 0.75 }}
        >
          by Egoriy_Bobryshev
        </span>
      </div>
      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent
          className={`max-w-md ${
            theme.mode === "dark" ? "bg-[#111] border-white/10 text-white" : "bg-white border-gray-200 text-black"
          }`}
        >
          <DialogHeader>
          ...
          <div className="space-y-4 pt-1">
            <div
              className={`text-xs px-3 py-2 rounded-lg ${
                theme.mode === "dark" ? "bg-white/5 text-white/50" : "bg-gray-100 text-gray-500"
              }`}
            >
